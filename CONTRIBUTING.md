...
Read-first order: [README.md](./README.md) → [CONTRIBUTING.md](./CONTRIBUTING.md) (this file) → [Project Charter](./docs/project_charter.md) → [Getting Started](./docs/getting_started.md) → [Development Standards](./docs/development_standards.md) → [Implementation Schedule](./docs/implementation_schedule.md) → [System Overview](./docs/system_overview.md).
